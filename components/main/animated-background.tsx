...
export const AnimatedBackground = () => {
  ...
  const LAYERS = 3;
  const BEAMS_PER_LAYER = 6; // Reduced from 8
  ...
  useEffect(() => {
    ...
    const nCtx = noiseCanvas.getContext("2d", { alpha: false });
    if (!ctx || !nCtx) return;
    ...
    const animate = () => {
      ...
      // Generate noise every 3 frames instead of every frame
  ...
  return (
    <>
      <canvas ref={noiseRef} className="fixed inset-0 z-0 pointer-events-none" />
